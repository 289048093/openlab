...
public class TwoDimensionCodeUtil {
    ...
    public static void main(String[] args) {
        String imgPath = "D:/Michael.png"; //二维码图片保存路径
        //内容
        String encoderContent = "一个好人李朝";
    ...
    private static TwoDimensionCodeUtil newInstance = new TwoDimensionCodeUtil();
    public static TwoDimensionCodeUtil newInstance() {
        return newInstance;
    }
}
