	...
	<body>
				...
				<div class="content_detail">
					<div class="content_detail_title">
						<span style="padding-left: 10px;">下载中心</span>
					</div>
					...
					<div class="content_body_list">
						<table class="content_body_list_table">
							...
							<s:if
								...
								<s:iterator value="cloudContext.params.downloadFileCatVOs"
									var="downloadFileCat">
									<s:if test="downloadFile!=null && downloadFile.size>0">
										<s:iterator value="downloadFile" var="downloadFile">
											<tr>
												<td>
													<s:property value="id" />
												</td>
												...
												<!--<a
													href='downloadFileManager/downloadFile!detail.action?cloudContext.vo.id=<s:property value="id"/>'>
