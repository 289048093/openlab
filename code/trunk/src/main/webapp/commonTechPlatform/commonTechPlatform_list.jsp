...
<html>
	...
	<body>
		...
		<!-- right start -->
		<form
			action="commonTechPlatformManager/commonTechPlatform!query.action"
			id="myform" method="post">
			<div class="content_detail">
				<div class="content_detail_title">
					<img src="images/dh.gif"/>
				<span id="title">首页 ->公共技术服务平台</span>
				</div>
				<div>
					<ul class="content_detail_titleul">
						<s:if
							test="cloudContext.params.commonTechPlatformVOs!=null && cloudContext.params.commonTechPlatformVOs.size>0">
							<s:iterator value="cloudContext.params.commonTechPlatformVOs"
								var="commonTechPlatformVOs">
								<li>
									<a class="astyle"
										href='commonTechPlatformManager/commonTechPlatform!detail.action?cloudContext.vo.id=<s:property value="id"/>'>
										<s:property value="#request.commonTechPlatformVOs.name" /> </a>
								</li>
							</s:iterator>
						</s:if>
					</ul>
				...
				<!-- 分页 -->
				<pg:pager
					url="commonTechPlatformManager/commonTechPlatform!query.action"
