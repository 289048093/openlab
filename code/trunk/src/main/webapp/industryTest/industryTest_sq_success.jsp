	...
	<body>
		...
		<table width="680" align="center" cellpadding="2" cellspacing="1"
			...
			<tr>
				...
				<td height="40" colspan="3" align="left" style="color: red;"
					bgcolor="#FFFFFF">
					申请以成功提交，请注意查收审核结果。
				</td>
			</tr>
			<tr>
				<td height="35" colspan="2" align="center" style="color: red;"
					bgcolor="#FFFFFF">
						<div id="settimeclose">
				...
				<td height="35" colspan="2" align="center" bgcolor="#FFFFFF">
              	<a href="userCenter/main.jsp?linkFlag=2" target="_blank">点击进入个人中心行业检测订单</a>
