...
<html>
	...
	<body>
		...
		<!-- left end -->
		<!-- right start -->
		<form action="pointLabManager/pointLab!query.action" id="myform"
			method="post">
			<div class="content_detail">
				<div class="content_detail_title">
				<img src="images/dh.gif"/>
					<span id="title">首页-> 重点实验室</span>
				</div>
				<div>
					<ul class="content_detail_titleul">
						<s:if
							test="cloudContext.params.pointLabVOs!=null && cloudContext.params.pointLabVOs.size>0">
							<s:iterator value="cloudContext.params.pointLabVOs"
								var="pointLabVO">
								<li>
									<a class="astyle"
										href='pointLabManager/pointLab!detail.action?cloudContext.vo.id=<s:property value="id"/>'>
										<s:property value="#request.pointLabVO.name" /> </a>
								</li>
							</s:iterator>
						</s:if>
					</ul>
				...
				<!-- 分页 -->
				<pg:pager url="pointLabManager/pointLab!query.action"
