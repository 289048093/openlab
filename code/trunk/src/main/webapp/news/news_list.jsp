...
<html>
	...
	<body>
		...
		<div class="content_list">
			...
			<div>
				<ul class="title_listul">
					<s:if
						test="cloudContext.params.newsCatVOs!=null && cloudContext.params.newsCatVOs.size>0">
						<s:iterator value="cloudContext.params.newsCatVOs" var="newsCat">
							<li class="column_item_control_sml">
								<a
									href="newsManager/news!query.action?cloudContext.params.catId=<s:property value='id'/>"><s:property
										value="name" /> </a>
							</li>
						</s:iterator>
					</s:if>
		...
		<!-- left end -->
		<!-- right start -->
		<form action="newsManager/news!query.action" id="myform" method="post">
			<div class="content_detail">
				<div class="content_detail_title">
					<img src="images/dh.gif"/>
					<span id="title">首页 -&gt; 新闻通知</span>
				</div>
				<div>
					<ul class="content_detail_titleul">
						<s:if
							test="cloudContext.params.topNewsVOs!=null && cloudContext.params.topNewsVOs.size>0">
							<s:iterator value="cloudContext.params.topNewsVOs" var="newsVO">
								<li>
									<a class="astyle"
										href='newsManager/news!detail.action?cloudContext.vo.id=<s:property value="id"/>'>
										<s:property value="#request.newsVO.title" /> </a>
								</li>
							</s:iterator>
						</s:if>
						<s:if
							test="cloudContext.params.untopNewsVOs!=null && cloudContext.params.untopNewsVOs.size>0">
							<s:iterator value="cloudContext.params.untopNewsVOs" var="newsVO">
								<li>
									<a class="astyle"
										href='newsManager/news!detail.action?cloudContext.vo.id=<s:property value="id"/>'>
										<s:property value="#request.newsVO.title" /> </a>
				...
				<!-- 分页 -->
				<pg:pager url="newsManager/news!query.action"
